package com.ideathon.sign.idver.recognise;
...
public class SURFDetector {
    ...
    public static void main(String[] args) {
        ...
        String bookObject = "signature3.png";
        String bookScene = "signature3.png";

        System.out.println("Started....");
        System.out.println("Loading images...");
        Mat objectImage = Imgcodecs.imread(bookObject, Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
        Mat sceneImage = Imgcodecs.imread(bookScene, Imgcodecs.CV_LOAD_IMAGE_GRAYSCALE);
